...
# parser.add_argument('--snapshot', type=str, default='snapshot/general_model.pth',
#         help='snapshot of models to eval')

parser.add_argument('--snapshot', type=str, default='snapshot/checkpoint_e9.pth',
        help='snapshot of models to eval')

parser.add_argument('--config', type=str, default='../experiments/siamcar_r50/config.yaml',
        help='config file')
#--config
#/home/siton/caoping/SiamCAR-master/experiments/siamcar_r50/config.yaml
